      ...
      $.ajax({
        ...
        complete: function (data) {
          ...
          setTimeout(function () {
            ...
            // Timeline Filter
            if ($("#timelineFilter").get(0)) {
              var category = $("#timelineFilter > li > a.active").data(
                  "filter-category"
                ),
                timelineBox = $("#timelineFilterContent").find(".timeline-box");
    ...
    callbacks: {
      ajaxContentAdded: function () {
        ...
        if ($("a[data-ajax-on-modal]").length <= 1) {
          $wrapper
            .find("a[data-ajax-portfolio-prev], a[data-ajax-portfolio-next]")
            .remove();
        } else {
          // Prev
          $wrapper
            .find("a[data-ajax-portfolio-prev]")
            .on("click", function (e) {
              e.preventDefault();
          ...
          // Next
          $wrapper
            .find("a[data-ajax-portfolio-next]")
            .on("click", function (e) {
              e.preventDefault();
