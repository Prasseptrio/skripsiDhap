    ...
    <div class="container d-flex justify-content-center">
        <div class="card card-body col-8 bg-white rounded-lg p-3">
            ...
            <form action="<?= base_url('profile/save'); ?>" method="post">
                <h3 class="text-6 text-center text-danger font-weight-semibold mb-4">Masukan Kode Otp</h3>
                ...
                <div class="text-center" id="btn-submit">
                    <button type="submit" class="btn btn-danger my-3 btn-3 font-weight-semibold" id="btnRegister">Simpan Password</button>
                </div>
            </form>
        </div>
    </div>
