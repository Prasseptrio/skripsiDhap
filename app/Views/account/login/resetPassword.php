            ...
            <div class="d-flex justify-content-center">
               <div class="col-md-6 ">
                  <div class="border border-light rounded p-5">
                     <div class="row">
                        <div class="col-sm-6">
                           <h2 class=" font-weight-bold text-color-dark text-4 mt-3 mb-4">Lupa Password</h2>
                        </div>
                     ...
                     <form action="<?= base_url('changePasswordForgot'); ?>" id="shopLoginSignIn" method="post">
                        <div class="form-row mb-2">
                           <div class="form-group col-lg-6">
                              ...
                              <small id="textPassword" class="form-text text-danger"> <?= (($validation->hasError('inputPassword'))) ? $validation->getError('inputPassword') : ''; ?></small>
                           </div>
                           <div class="form-group col-lg-6">
                        ...
                        <div class="row align-items-center">
                           <div class="col text-right">
                              <button type="submit" class="btn btn-danger border-light btn-rounded btn-v-3 btn-h-3 font-weight-bold">Simpan Password</button>
                           </div>
                        </div>
                     </form>
                  </div>
