            ...
            <div class="row mb-5">
                ...
                <div class="col-lg-7">
                    ...
                    <ul class="list list-unstyled">
                        <li>Model : <strong><?; ?></strong></li>
                        <li>SKU : <strong><?= $product['product_sku']; ?></strong></li>
                        <li>Stok Menu: <strong><?= $product['stock_status']; ?></strong></li>
                    ...
                    <?php if ($product['price'] != 0) : ?>
                        <form class="shop-cart align-items-center" action="<?= base_url('addToCart'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <button type="button" class="add-to-cart btn btn-danger border-light btn-rounded font-weight-bold text-3 btn-v-3 btn-h-2 btn-fs-2 ml-3 BtnCheckout" data-name="<?= $product['product_name']; ?>" data-price="<?= $product['price']; ?>" data-sku="<?= $product['product_sku']; ?>" data-image="<?= $product['product_image']; ?>"><i class="lnr lnr-store text-2"></i>&nbsp Beli Sekarang</button>
                        </form>
                    <?php else : ?>
